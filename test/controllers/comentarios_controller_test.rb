...
class ComentariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create comentario" do
    assert_difference("Comentario.count") do
      post comentarios_url, params: { comentario: { autor: @comentario.autor, content: @comentario.content, post_id: @comentario.post_id } }
    end
  ...
  test "should update comentario" do
    patch comentario_url(@comentario), params: { comentario: { autor: @comentario.autor, content: @comentario.content, post_id: @comentario.post_id } }
